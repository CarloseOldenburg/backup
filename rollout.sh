...
wget https://cdn.vsd.app/softwares/vsd-payment/prod/vsd-payment_1.9.0_amd64.deb 2>&1 | tee -a $LOG_FILE
...
sudo dpkg -i vsd-payment_1.9.0_amd64.deb 2>&1 | tee -a $LOG_FILE
